...
export const PopularCardsFragment = () => {
  ...
  console.log(Styles)
    return (
              ...
              <div className={Styles['card__content-block']}>
                ...
                <div className={Styles['card__info-container']}>
                  <p className={Styles.card__author}>
                    Автор: <span className={Styles.card_accent}>Lonely Baobab</span>
                  </p>
            ...
            <article className={Styles.card}>
              ...
              <div className={Styles['card__content-block']}>
                ...
                <div className={Styles['card-info__container']}>
                  <p className={Styles.card__author}>
                    Автор: <span className={Styles.card_accent}>F-Style</span>
                  </p>
                  <p className={Styles.card__votes}>
        ...
        <li className="cards-list__item">
          <a href="/game-id.html" className={Styles['card-list_link']}>
            <article className={Styles.card}>
              <img
